...
export const circle = <i class="fa-solid fa-retweet"></i>

export const necessary = <i class="fa-solid fa-dollar-sign"></i>
export const personal = <i class="fa-solid fa-person"></i>
export const education = <i class="fa-solid fa-school"></i>
export const long_term = <i class="fa-solid fa-arrow-up-wide-short"></i>